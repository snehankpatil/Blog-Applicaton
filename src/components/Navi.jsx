...
function Navi(params) {
    ...
    return (
        <div>
            <nav className=" z-50 py-2 border-gray-200  relative  bg-opacity-50 bg-sky-700   w-full ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <ul className="f flex flex-row justify-between items-center gap-4">
            <li>
              <a
            //    onClick={(GotoUser)} 
               className="block text-2xl py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                <FaRegUserCircle/>
              </a>
            </li>
        ...
        <div className={` items-end justify-end   ${isMenuVisible ? 'flex' : 'hidden'} w-full md:flex md:w-auto md:order-1`} id="navbar-cta">
          <ul className="flex flex-col  font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:border-gray-700">
            <li>
              <a href="#" className="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500"
            //    onClick={()=>(navi("/home"))}
